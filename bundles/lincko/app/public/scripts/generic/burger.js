var burger = function(elem){
	...
	var burger_destroy = function(){
		...
		console.log(elem);
		console.log('current caret: '+getCaretCharacterOffsetWithin(elem[0]).caretOffset);
		burger_on = false;
	 	burger_str = "";
	 	burger_type = null;
	...
	function getCaretCharacterOffsetWithin(element) {
	    ...
	    //x,y adjustment for lincko work area
	...
	elem.keypress(function(event){
 		 ...
 		 if( burger_on ){
 		 	...
 		 	burger_str = elem.text().substring(burger_startIndex+1,getCaretCharacterOffsetWithin(elem[0]).caretOffset)+char;
 		 ...
 		 if( char == '@' ){
 		 	burger_type = 'users';
 		 	burger_on = true;
 		 	var coord = getCaretCharacterOffsetWithin(elem[0]);
