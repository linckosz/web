...
$(function () {
	...
	$('#app_upload_fileupload').fileupload({
		...
		dataType: 'json',
		url: top.location.protocol+'//'+document.linckoBack+'file.'+document.domain+':8443/file', //Bruno update
		url_result: top.location.protocol++'//'+document.linckoBack+'file.'+document.domain+':8443/result?%s',
