var responsive = {
	...
	isTablet: "only screen and (min-width: 901px) and (max-width: 1280px)",
	isDesktop: "only screen and (min-width: 1281px)",

	minMobile: "",
	minMobileL: "only screen and (min-width: 480px)",
	minTablet: "only screen and (min-width: 901px)",
	minDesktop: "only screen and (min-width: 1281px)",

	noMobile: "only screen and (min-width: 480px)",
	noMobileL: "only screen and (min-width: 901px), only screen and (max-width: 479px)",
	noTablet: "only screen and (min-width: 1281px), only screen and (max-width: 900px)",
	noDesktop: "only screen and (max-width: 1280px)",
